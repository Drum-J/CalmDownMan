...
import chimhaha.chimcard.game.dto.CardPlayRequestDto;
...
public class GameController {
    ...
    public void playCard(@DestinationVariable Long gameRoomId, CardPlayRequestDto dto) {
        Long accountId = AccountUtils.getAccountId();
        if (!dto.playerId().equals(accountId)) {
            throw new IllegalArgumentException("사용자 정보가 일치하지 않습니다.");
        }

        gameService.playCard(gameRoomId, dto.playerId(), dto.gameCardId());
    }
}
