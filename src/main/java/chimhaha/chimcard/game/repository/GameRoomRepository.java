...
public interface GameRoomRepository extends JpaRepository<GameRoom, Long> {
    ...
    @Query("SELECT g FROM GameRoom g JOIN FETCH g.player1 JOIN FETCH g.player2 WHERE g.p1SessionId = :sessionId OR g.p2SessionId = :sessionId")
    Optional<GameRoom> findWithPlayersBySessionId(@Param("sessionId") String sessionId);
